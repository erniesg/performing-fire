...
## DONE(og-png, rendered 2026-07-26 via headless Chrome from og.svg): render the raster
...
`public/experiments/index.html`, and delete the `DONE(og-png, rendered 2026-07-26 via headless Chrome from og.svg)` comment from each. Drop this
...
- If it is `og.svg`, the `DONE(og-png, rendered 2026-07-26 via headless Chrome from og.svg)` marker must be present here and in all three pages.
